          ...
          <div class="d-flex align-items-baseline flex-wrap mr-5">
            ...
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
              <li class="breadcrumb-item text-muted">
                <a href="" class="text-muted">Manage Category</a>
              </li>
              <li class="breadcrumb-item text-muted">
        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            ...
            <div class="card-toolbar">
              ...
              <div class="btn-group">
                <a href="{{ route('categories.store') }}"  onclick="event.preventDefault(); document.getElementById('categories_add_form').submit();" id="kt_btn" class="btn btn-primary font-weight-bolder">
          ...
          <!--begin::Form-->
            {{ Form::open([ 'route' => 'categories.store','class'=>'form' ,"id"=>"categories_add_form", 'enctype'=>'multipart/form-data']) }}
              @csrf
              <div class="row">
