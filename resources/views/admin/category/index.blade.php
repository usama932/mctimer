    ...
    <div class="card card-custom">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <form action="{{ route('admin.delete-selected-category') }}" method="post" id="category_form">
...
@section('scripts')
    ...
    <script>
        ...
        var clients = $('#categories').DataTable({
            "order": [
                [1, 'asc']
            ],
            "processing": true,
        ...
        function del(id) {
            Swal.fire({
                title: "If you delete this category ,releted products will also deleted .Are you sure?",
                ...
                if (result.value) {
                    ...
                    window.location.href = APP_URL + "/admin/category/delete/" + id;
                }
            });
        }
