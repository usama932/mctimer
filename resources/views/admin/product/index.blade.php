    ...
    <div class="card card-custom">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <form action="{{ route('admin.delete-selected-products') }}" method="post" id="product_form">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <!--begin: Datatable-->
                    <table class="table table-bordered table-hover table-checkable" id="products"
...
@section('scripts')
    ...
    <script>
        ...
        var clients = $('#products').DataTable({
            "order": [
                [1, 'asc']
            ],
            "processing": true,
