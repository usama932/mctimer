							...
							<div class="card-spacer mt-n25">
								...
								<div class="row m-0">
									...
									<div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
										...
										<a href="#" class="text-primary font-weight-bold font-size-h6 mt-2">Cateogries  ({{$category ?? '0'}})</a>
									</div>
								</div>
								<!--end::Row-->
								<!--begin::Row-->
								<div class="row m-0">
									<div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
										...
										<a href="#" class="text-danger font-weight-bold font-size-h6 mt-2">Product  ({{$product ?? '0'}})</a>
									</div>
